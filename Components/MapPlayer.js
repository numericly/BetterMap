...
class MapPlayer {
    ...
    drawIcon(renderContext, dungeon, overrideX, overrideY) {
        ...
        this.drawAt(x2 + rx + renderContext.offset / 2, y2 + ry, rw, rh, renderContext.showHeads === "icons" || renderContext.showHeads === 'self-icon' && this.username === Player.getName(), this.yaw.get(), renderContext.headBorder !== 'none' ? renderContext.headBorderWidth : 0)
